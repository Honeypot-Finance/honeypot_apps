...
// Use dynamic current time for more reliable tests
...
describe('useReceipt', () => {
  ...
  describe('Receipt Data Handling', () => {
    const mockReceiptData: Receipt = {
      ...
      claimableAt: BigInt(getCurrentTime() + 3600), // 1 hour from now
      claimed: false,
    };
  ...
  describe('Claimable Conditions', () => {
    ...
    it('should return false when receipt is already claimed', () => {
      const claimedReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() - 3600), // 1 hour ago
        claimed: true,
      };
    ...
    it('should return true when claimableAt equals current time', () => {
      const exactTimeReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime()),
        claimed: false,
      };
  ...
  describe('Cooldown Formatting', () => {
    ...
    it('should return "00:00:00" when receipt is already claimed', () => {
      const claimedReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 3600),
        claimed: true,
      };
    ...
    it('should format remaining time correctly for hours, minutes, seconds', () => {
      const futureReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 3661), // 1 hour, 1 minute, 1 second
        claimed: false,
      };
      ...
      expect(result.current).toMatch(/^01:0[01]:0[01]$/);
    });
    ...
    it('should format time with leading zeros', () => {
      const futureReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 125), // 2 minutes, 5 seconds
        claimed: false,
      };
      ...
      // Allow for 1-2 second variance due to test execution time
      expect(result.current).toMatch(/^00:02:0[3-5]$/);
    });
    ...
    it('should handle exactly 1 hour remaining', () => {
      const futureReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 3600), // Exactly 1 hour
        claimed: false,
      };
      ...
      // Allow for 1-2 second variance due to test execution time
      expect(result.current).toMatch(/^00:59:5[89]|01:00:00$/);
    });
    ...
    it('should handle exactly 1 minute remaining', () => {
      const futureReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 60), // Exactly 1 minute
        claimed: false,
      };
      ...
      // Allow for 1-2 second variance due to test execution time
      expect(result.current).toMatch(/^00:00:5[89]|00:01:00$/);
    });
    ...
    it('should handle exactly 1 second remaining', () => {
      const futureReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 1), // Exactly 1 second
        claimed: false,
      };

      const { result } = renderHook(() => useFormattedCooldownTime(futureReceipt));

      // Allow for timing variance - could be 0 or 1 second due to test execution time
      expect(result.current).toMatch(/^00:00:0[01]$/);
    });
  });
  ...
  describe('Edge Cases', () => {
    it('should handle very long cooldown periods', () => {
      const longCooldownReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() + 86400), // 24 hours
        claimed: false,
      };
      ...
      // Allow for 1-2 second variance due to test execution time
      expect(result.current).toMatch(/^23:59:5[89]|24:00:00$/);
    });
    ...
    it('should handle negative remaining time (past claimable time)', () => {
      const pastReceipt: Receipt = {
        ...
        token: '0x0987654321098765432109876543210987654321' as `0x${string}`,
        receiptWeight: BigInt('1000000000000000000000'),
        claimableAt: BigInt(getCurrentTime() - 1000), // 1000 seconds ago
        claimed: false,
      };
